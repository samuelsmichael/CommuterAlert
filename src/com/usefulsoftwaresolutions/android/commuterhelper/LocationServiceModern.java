...
com.google.android.gms.location.LocationListener{
    ...
    private LocationRequest getLocationRequest() {
    	if(mLocationRequest==null) {
            ...
            mLocationRequest.setFastestInterval((int)(updateInterval/2));
    	}
	...
	public void onConnected(Bundle arg0) {
		try {
			mLocationClient.requestLocationUpdates(getLocationRequest(), this); // Don't know why Scott is getting this error.
		} catch (Exception e) {
			try { // let's abort, and start over
            	...
            	new Logger(
	    				Integer.parseInt(settings.getString("LoggingLevel", String.valueOf(GlobalStaticValues.LOG_LEVEL_CRITICAL))),
	    				"onConnected", this)
	    				.log("Error requestLocationUpdates; stopping and letting ActivityRecognitionService restart", GlobalStaticValues.LOG_LEVEL_NOTIFICATION);
			} catch (Exception e2) {
			}
		}
	}
