...
import com.usefulsoftwaresolutions.android.commuterhelper.Home2.WarningAndInitialDialog;
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.action_contactus:
				...
				sendIntent.putExtra(Intent.EXTRA_SUBJECT, "Message from Commuter Alarm user"
						.toString());
